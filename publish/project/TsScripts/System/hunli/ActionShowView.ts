...
export class ActionShowView extends CommonForm {
    ...
    open(itemData: ThingItemData = null, lingbaoId: number = 0) {
        //if (lingbaoId == 0)
        //{
    ...
    private setModlePosTransform() {
        this.modelParentTransform.localPosition = new UnityEngine.Vector3(-10, -85, 0);
        this.modelParentTransform.transform.rotation = UnityEngine.Quaternion.Euler(0, 180, 0);
        this.modelParentTransform.transform.localScale = new UnityEngine.Vector3(120, 120, 120);
    }
