...
export class SceneResultPassPanel extends NestedSubForm {
    ...
    constructor() {
        super(EnumSceneResultId.pass);
    }

    protected resPath(): string {
        return UIPathData.SceneResultPassView;
    }
    ...
    protected onOpen() {
        ...
        if (this.resultInfo.m_ucShowExit == Macros.SCENERESULT_BUT_SHOW_TIMER || this.resultInfo.m_ucShowNext == Macros.SCENERESULT_BUT_SHOW_TIMER) {
            ...
            this.addTimer("btnTimer", 1000, this.countDownSec, this.onBtnTimer);
            this.updateBtnTime(this.countDownSec);
        } else {
            this.removeTimer("btnTimer");
        }
