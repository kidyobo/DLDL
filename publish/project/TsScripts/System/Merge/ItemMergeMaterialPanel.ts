...
export class ItemMergeMaterialPanel extends ItemMergeItemBasePanel {

    
    constructor() {
        super(KeyWord.OTHER_FUNCTION_MERGE_MATERIAL);
    }

    // [KeyWord.MERGER_CLASS1_PET, KeyWord.MERGER_CLASS1_EQUIP, KeyWord.MERGER_CLASS1_STRONG_ITEM];
    protected onOpen() {
        this.curTab = KeyWord.MERGER_CLASS1_STRONG_ITEM;
        super.onOpen();
    }
