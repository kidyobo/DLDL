...
export class KaiFuZhiZunDuoBaoView extends CommonForm {
    ...
    protected onOpen() {
        ...
        this.title_kaiFu.SetActive(true);
    ...
    updatePanel(): void {
        ...
        let zzzdData: Protocol.ZZZDOpenPanelRsp = G.DataMgr.activityData.kfzzzdData;
        if (zzzdData == null) {
            return;
        }
