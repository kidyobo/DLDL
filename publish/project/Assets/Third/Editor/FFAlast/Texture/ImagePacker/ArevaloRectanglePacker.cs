...
internal class ArevaloRectanglePacker : RectanglePacker
{
    ...
    private bool IsFree(ref Rect rectangle, int testedPackingAreaWidth, int testedPackingAreaHeight)
    {
        ...
        bool leavesPackingArea = (rectangle.x < 0) || (rectangle.y < 0) || (rectangle.xMax > testedPackingAreaWidth) || (rectangle.yMax > testedPackingAreaHeight);
