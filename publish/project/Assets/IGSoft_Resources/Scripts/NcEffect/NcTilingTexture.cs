...
public class NcTilingTexture : NcEffectBehaviour
{
	...
	void Start()
	{
        ...
        if (m_renderer != null && mat != null)
		{
            mat.mainTextureScale	= new Vector2(m_fTilingX, m_fTilingY);
            mat.mainTextureOffset = new Vector2(m_fOffsetX - ((int)m_fOffsetX), m_fOffsetY - ((int)m_fOffsetY));
		}
	}
