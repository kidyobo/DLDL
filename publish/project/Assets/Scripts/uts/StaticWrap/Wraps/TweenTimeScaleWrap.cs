...
using UnityEngine;
namespace Uts {
	public class TweenTimeScaleWrap {
		public static IntPtr jsClass;
		[MonoPInvokeCallbackAttribute(typeof(jvm_ctor_callback))]
		public static IntPtr ctor(IntPtr context, IntPtr ctor, int argcnt, IntPtr args, IntPtr exception) {
			try {
				var obj = new TweenTimeScale();
		...
		public static IntPtr Begin_S(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				...
				var ret = TweenTimeScale.Begin(p0, p1, p2, p3);
		...
		public static IntPtr SetStartToCurrentValue(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				var obj = ((TweenTimeScale)ToCsObjects.ToCsObject(context, thisObj));
		...
		public static IntPtr GetType_S(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				Type csType = typeof(TweenTimeScale);
		...
		static public void Register(IntPtr env) {
			...
			jsClass = Native.jvm_reg_class_end(env, "TweenTimeScale", UITweenerWrap.jsClass, ctor, ObjectsMgr.dtor);
			RegHelper.RegisterJsClass(typeof(TweenTimeScale), jsClass);
		}
	}
}
