...
namespace Uts {
	public class TweenPositionWrap {
		...
		public static IntPtr Begin_S(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				if (argcnt == 3) {
					...
					var ret = TweenPosition.Begin(p0, p1, p2);
					...
					var ret = TweenPosition.Begin(p0, p1, p2, p3);
					return MakeJsObjects.MakeJsObject(context, ret);
		...
		public static IntPtr SetStartToCurrentValue(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				var obj = ((TweenPosition)ToCsObjects.ToCsObject(context, thisObj));
		...
		public static IntPtr GetType_S(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				Type csType = typeof(TweenPosition);
		...
		static public void Register(IntPtr env) {
			...
			jsClass = Native.jvm_reg_class_end(env, "TweenPosition", UITweenerWrap.jsClass, ctor, ObjectsMgr.dtor);
			RegHelper.RegisterJsClass(typeof(TweenPosition), jsClass);
		}
	}
}
