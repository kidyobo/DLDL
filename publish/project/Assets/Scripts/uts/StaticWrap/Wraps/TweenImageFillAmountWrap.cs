...
using UnityEngine;
namespace Uts {
	public class TweenImageFillAmountWrap {
		public static IntPtr jsClass;
		[MonoPInvokeCallbackAttribute(typeof(jvm_ctor_callback))]
		public static IntPtr ctor(IntPtr context, IntPtr ctor, int argcnt, IntPtr args, IntPtr exception) {
			try {
				var obj = new TweenImageFillAmount();
		...
		public static IntPtr Begin_S(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				...
				var ret = TweenImageFillAmount.Begin(p0, p1, p2);
		...
		public static IntPtr SetStartToCurrentValue(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				var obj = ((TweenImageFillAmount)ToCsObjects.ToCsObject(context, thisObj));
		...
		[MonoPInvokeCallbackAttribute(typeof(jvm_get_callback))]
		public static IntPtr cachedImageGetter(IntPtr context, IntPtr thisObj, IntPtr name, IntPtr exception) {
			try {
				var obj = ((TweenImageFillAmount)ToCsObjects.ToCsObject(context, thisObj));
				return MakeJsObjects.MakeJsObject(context, obj.cachedImage);
			} catch (Exception e) { return Native.jvm_throwerr(context, exception, e.ToString()); }
		}
		...
		public static IntPtr GetType_S(IntPtr context, IntPtr function, IntPtr thisObj, int argcnt, IntPtr args, IntPtr exception) {
			try {
				Type csType = typeof(TweenImageFillAmount);
		...
		static public void Register(IntPtr env) {
			...
			Native.jvm_reg_property(env, "cachedImage", cachedImageGetter, null);
			...
			jsClass = Native.jvm_reg_class_end(env, "TweenImageFillAmount", UITweenerWrap.jsClass, ctor, ObjectsMgr.dtor);
			RegHelper.RegisterJsClass(typeof(TweenImageFillAmount), jsClass);
		}
	}
}
