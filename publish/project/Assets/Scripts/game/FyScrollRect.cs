...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    /// <remarks>
    /// FyScrollRect will not do any clipping on its own. Combined with a Mask component, it can be turned into a scroll view.
    /// </remarks>
    public class FyScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
        ...
        /// {
        ///     public FyScrollRect myScrollRect;
        ...
        ///         if (option == 0)
        ///         {
        ///             myScrollRect.movementType = FyScrollRect.MovementType.Clamped;
        ///         }
        ///         else if (option == 1)
        ///         {
        ///             myScrollRect.movementType = FyScrollRect.MovementType.Elastic;
        ///         }
        ///         else if (option == 2)
        ///         {
        ///             myScrollRect.movementType = FyScrollRect.MovementType.Unrestricted;
        ///         }
        ///     }
        /// }
        /// </code>
        ...
        [Serializable]
        /// <summary>
        /// Event type used by the FyScrollRect.
        /// </summary>
        ...
        /// <summary>
        /// The content that can be scrolled. It should be a child of the GameObject with FyScrollRect on it.
        /// </summary>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        ///     public void Start()
        ///     {
        ///         // assigns the contect that can be scrolled using the FyScrollRect.
        ...
        private System.Action m_beginDragCallback;
        public System.Action BeginDragCallback { get { return m_beginDragCallback; } set { m_beginDragCallback = value; } }
        private System.Action m_endDragCallback;
        public System.Action EndDragCallback { get { return m_endDragCallback; } set { m_endDragCallback = value; } }

        /// <summary>
        /// Optional Scrollbar object linked to the horizontal scrolling of the FyScrollRect.
        /// </summary>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the FyScrollRect, allowing you to scroll in the horizontal axis.
        ...
        /// <summary>
        /// Optional Scrollbar object linked to the vertical scrolling of the FyScrollRect.
        /// </summary>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the FyScrollRect, allowing you to scroll in the vertical axis.
        ...
        /// </summary>
        /// <remarks>
        /// onValueChanged is used to watch for changes in the FyScrollRect object.
        ...
        /// The UnityEvent.AddListener API for UI.FyScrollRect._onValueChanged takes a Vector2.
        ///
        ...
        /// shows how this can be done.The script is attached to the FyScrollRect object.
        /// </remarks>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        /// {
        ///     static FyScrollRect scrollRect;
        ///
        ///     void Start()
        ///     {
        ///         scrollRect = GetComponent<FyScrollRect>();
        ...
        ///     public void Start()
        ///     {
        ///         //Checks if the FyScrollRect called "myScrollRect" is active.
        ...
        protected virtual void LateUpdate()
        {
            ...
            {
                //bool oldvel = m_Velocity != Vector2.zero;
                Vector2 position = m_Content.anchoredPosition;
                for (int axis = 0; axis < 2; axis++)
                {
                    // Apply spring physics if movement is elastic and content has an offset from the view.
                    if ((m_MovementType == MovementType.Elastic || movementType == MovementType.NoCross) && offset[axis] != 0)
                    {
                    ...
                    else if (movementType == MovementType.NoCross && sliceSize != Vector2.zero && sliceSize[axis] > 0) {
                        var sx = m_ContentBounds.size[axis] * sliceSize[axis];
                        float speed = m_Velocity[axis];
                        position[axis] = Mathf.SmoothDamp(m_Content.anchoredPosition[axis], sx * Mathf.Floor(position[axis] / sx + 0.5f), ref speed, m_Elasticity, Mathf.Infinity, deltaTime);
                        if (Mathf.Abs(speed) < 1) 
                            speed = 0;
                        m_Velocity[axis] = speed;
                    }
                ...
                // if(oldvel && m_Velocity == Vector2.zero) {
                //     Debug.Log("velocity turn to zero! " + offset.x + "," + offset.y);
                //     if(sliceSize != null) {
                //         if(sliceSize.x > 0) {
                //             var sx = m_ContentBounds.size.x * sliceSize.x;
                //             position.x = sx * Mathf.Floor(position.x / sx + 0.5f);
                //         } else {
                //             var sy = m_ContentBounds.size.y * sliceSize.y;
                //             position.y = sy * Mathf.Floor(position.y / sy + 0.5f);
                //         }
                //     }
                // }
            ...
            if (m_ViewBounds != m_PrevViewBounds || m_ContentBounds != m_PrevContentBounds || m_Content.anchoredPosition != m_PrevPosition)
            {
                ...
                // UISystemProfilerApi.AddMarker("FyScrollRect.value", this);
        ...
        /// <summary>
        /// Helper function to update the previous data fields on a FyScrollRect. Call this before you change data in the FyScrollRect.
        /// </summary>
        ...
        /// <summary>
        /// Calculate the bounds the FyScrollRect should be using.
        /// </summary>
